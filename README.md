  ...
  ## 2.1 Modelo ollama
   ...
   - Instalar ollama y modelos
      ...
      **NOTA:**
        ...
        - Si lo anterior no se cumple se debe modificar OLLAMA_NUM_PARALLEL. Ollama carga automaticamente el modelo según el parámetro anterior. Como base, OLLAMA_NUM_PARALLEL=20 necesita al rededor de 100 VRAM (total, puede ser la suma de varias GPUs menores).  
